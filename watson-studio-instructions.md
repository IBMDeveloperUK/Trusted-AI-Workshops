...
To run a Jupyter notebook in Watson Studio, start by signing up for a [free Cloud account](https://ibm.biz/BdqNqh) (or [log in](https://ibm.biz/BdqNqh) if you have an account already). After filling in the form, you will receive a verification code by email, so please use a real address.
